...
resource sharepoint_file_processing_test_without_duplicates 'Microsoft.ServiceBus/namespaces/queues@2024-01-01' = {
  parent: servicebus_namespace
  name: 'sharepoint_file_processing_test_without_duplicates'
  location: 'eastus2'
  properties: {
